...
public class PatientInputDto {
  ...
  public void validate() {
    if (!gender.equals(GenderType.MAN.getGender()) && !gender
        .equals(GenderType.WOMAN.getGender())) {
      throw new BadRequestException(String.format("Gender must be type %s or %s",
          GenderType.MAN.getGender(), GenderType.WOMAN.getGender()),
          ServiceErrorCode.INVALID_GENDER_TYPE);
    }
  }
}
